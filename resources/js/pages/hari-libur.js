...
function handleResizeAndDrop({ event }) {
    ...
    el.setAttribute(
        "data-action",
        window.location.origin + `/hari-libur/${event.id}`
    );
...
let calendar = new Calendar(calendarEl, {
    ...
    eventClick: ({ event }) => {
        ...
        el.setAttribute(
            "data-action",
            window.location.origin + `/hari-libur/${event.id}/edit`
        );
        el.innerText = "Tambah";
    ...
    dateClick: (ev) => {
        ...
        el.setAttribute(
            ...
            window.location.origin +
                `/hari-libur/create?tanggal_awal=${ev.dateStr}&tanggal_akhir=${ev.dateStr}`
        );
        el.innerText = "Tambah";
