...
<div class="mb-2 form-wrapper">
    ...
    <div class="input-group input-daterange datepicker date" data-date-format="dd-mm-yyyy">
        <input class="form-control" required="" type="text" id="{{ $date_name1 }}" name="{{ $date_name1 }}" value="{{ $date_value1 }}" readonly="">
        <span class="bg-primary text-light px-3 justify-content-center align-items-center d-flex">sd</span>
        <input class="form-control" required="" type="text" id="{{ $date_name2 }}" name="{{ $date_name2 }}" value="{{ $date_value2 }}" readonly="">
    </div>
</div>